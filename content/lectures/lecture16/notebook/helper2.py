...
# By subtracting 0.5 from each normalized pixel value, the range is shifted to [-0.5, 0.5]. 
# This step centers the pixel values around 0, making the distribution more symmetric and improving convergence during training.
num_classes = 10
...
def cnn_model():
    ...
    # The functionality and behavior of the model will be the same in both cases.
